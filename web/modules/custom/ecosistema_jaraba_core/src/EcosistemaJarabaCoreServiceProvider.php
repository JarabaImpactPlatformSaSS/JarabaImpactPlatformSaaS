...
use Drupal\ecosistema_jaraba_core\DependencyInjection\Compiler\DailyActionsCompilerPass;
...
class EcosistemaJarabaCoreServiceProvider extends ServiceProviderBase {
  ...
  public function register(ContainerBuilder $container): void {
    ...
    $container->addCompilerPass(new DailyActionsCompilerPass());
    ...
    if (isset($modules['jaraba_skills']) && isset($modules['jaraba_tenant_knowledge'])) {
      ...
      // AUDIT-CONS-N10: Proper DI for tenant context.
        ->addArgument(new Reference('ecosistema_jaraba_core.tenant_context'))
      // FIX-015: Guardrails para queries RAG.
        ->addArgument(new Reference('ecosistema_jaraba_core.ai_guardrails'));
    }
  }
