  ...
  public function emprendimientoLanding(): array
  {
    return $this->buildLanding([
      ...
      'faq' => [
        ...
        ['question' => $this->t('¿Puedo acceder a mentoría directa?'), 'answer' => $this->t('Sí. Los planes Pro y Enterprise incluyen sesiones Mastermind grupales mensuales. Además, puedes contratar sesiones individuales 1:1 como servicio profesional aparte.')],
        ...
        ['question' => $this->t('¿Qué son los niveles de expertise?'), 'answer' => $this->t('Un sistema de progresión con XP acumulado en 5 niveles: Explorador, Iniciado, Profesional, Experto y Master. Cada nivel desbloquea beneficios reales: descuentos exclusivos, Mastermind prioritario e invitaciones a eventos.')],
