...
class AIOpsService {
  ...
  protected function predictPerformanceDegradation(): array {
    ...
    $riskLevel = 'none';
    // > 2s.
    if ($latencyTrend['current_avg'] > 2000) {
      $riskLevel = 'high';
      // Creciendo > 10%/día.
    }
    elseif ($latencyTrend['growth_rate'] > 10) {
      $riskLevel = 'medium';
    }
  ...
  protected function predictErrorSpike(): array {
    ...
    elseif ($errorTrend['growth_rate'] > 50) {
      $riskLevel = 'medium';
    }
