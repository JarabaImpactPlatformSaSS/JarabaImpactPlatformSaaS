...
class AIValueDashboardService {
  ...
  // Valor directo.
    self::VALUE_SALES_GENERATED => 1.0,
  // €25/hora ahorrada.
    self::VALUE_TIME_SAVED => 25.0,
  // €15/lead.
    self::VALUE_LEADS_GENERATED => 15.0,
  // €50/contenido.
    self::VALUE_CONTENT_CREATED => 50.0,
  // €100/cliente retenido.
    self::VALUE_CUSTOMER_RETENTION => 100.0,
  // €5/ticket evitado.
    self::VALUE_SUPPORT_DEFLECTED => 5.0,
  ];
