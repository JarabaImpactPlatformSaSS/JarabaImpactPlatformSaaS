...
class TenantContextService {
   ...
   */
  protected function calculateMemberMetrics(?GroupInterface $group, array $planLimits): array {
    $count = 0;
   ...
   */
  protected function calculateStorageMetrics(array $planLimits, ?GroupInterface $group = NULL): array {
    // Límite en MB.
   ...
   */
  protected function calculateContentMetrics(?GroupInterface $group): array {
    $count = 0;
