/**
 * @file
 * Ecosistema Jaraba - Integración con AutoFirma
 *
...
(function (Drupal, drupalSettings, once) {
   ...
   */
  Drupal.ecosistemaJarabaFirma = Drupal.ecosistemaJarabaFirma || {};
   ...
   */
  Drupal.behaviors.ecosistemaJarabaFirma = {
    attach: function (context, settings) {
      // Inicializar botones de firma
      once('ecosistema-jaraba-firma', '.btn-firmar-documento', context).forEach(function (button) {
        button.addEventListener('click', function (e) {
          e.preventDefault();
          const documentId = this.dataset.documentId;
          const documentTitle = this.dataset.documentTitle || 'Documento';
          
          Drupal.ecosistemaJarabaFirma.iniciarFirma(documentId, documentTitle);
        });
      });

      // Verificar disponibilidad de AutoFirma al cargar
      if (context === document) {
        Drupal.ecosistemaJarabaFirma.checkAutoFirmaAvailability();
      }
    }
  };
   ...
   */
  Drupal.ecosistemaJarabaFirma.checkAutoFirmaAvailability = async function () {
   ...
   * @returns {Promise<boolean>}
   */
  Drupal.ecosistemaJarabaFirma.tryWebSocketConnection = function (port) {
   ...
   */
  Drupal.ecosistemaJarabaFirma.iniciarFirma = async function (documentId, documentTitle) {
   ...
   */
  Drupal.ecosistemaJarabaFirma.fetchDocument = async function (documentId) {
   ...
   */
  Drupal.ecosistemaJarabaFirma.signDocument = function (docData) {
    return new Promise((resolve, reject) => {
      ...
      const successCallback = function (signatureB64, certificateB64) {
        ...
        let certInfo = {};
        try {
          certInfo = Drupal.ecosistemaJarabaFirma.parseCertificate(certificateB64);
        } catch (e) {
   ...
   * @returns {Promise<Object>}
   */
  Drupal.ecosistemaJarabaFirma.signWithProtocol = function (docData, signParams) {
    return new Promise((resolve, reject) => {
   ...
   * @returns {Promise<Object>}
   */
  Drupal.ecosistemaJarabaFirma.uploadSignedDocument = async function (documentId, signedData) {
    // Obtener token CSRF
   ...
   */
  Drupal.ecosistemaJarabaFirma.getCsrfToken = async function () {
   ...
   * @returns {Object}
   */
  Drupal.ecosistemaJarabaFirma.parseCertificate = function (certB64) {
   ...
   * @returns {string}
   */
  Drupal.ecosistemaJarabaFirma.getErrorMessage = function (error) {
    const errorMap = {
   ...
   */
  Drupal.ecosistemaJarabaFirma.showModal = function (options) {
   ...
   * @param {Object} options
   */
  Drupal.ecosistemaJarabaFirma.updateModal = function (options) {
   ...
   * @returns {string}
   */
  Drupal.ecosistemaJarabaFirma.getModalContent = function (options) {
    const statusIcons = {
