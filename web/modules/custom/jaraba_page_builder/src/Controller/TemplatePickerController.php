...
class TemplatePickerController extends ControllerBase {
  ...
  public function listTemplates(): array {
    ...
    // Cast a string para evitar que TranslatableMarkup se re-envuelva en t().
    // @see docs/00_DIRECTRICES_PROYECTO.md (Internacionalización)
    $category_labels = [
      'hero' => (string) $this->t('Hero'),
      'content' => (string) $this->t('Content'),
      'cta' => (string) $this->t('Call to Action'),
      'features' => (string) $this->t('Features'),
      'testimonials' => (string) $this->t('Testimonials'),
      'pricing' => (string) $this->t('Pricing'),
      'contact' => (string) $this->t('Contact'),
      'gallery' => (string) $this->t('Gallery'),
      'commerce' => (string) $this->t('Commerce'),
      'social' => (string) $this->t('Social'),
      'advanced' => (string) $this->t('Advanced'),
      'premium' => (string) $this->t('Premium'),
      'layout' => (string) $this->t('Layout'),
      'forms' => (string) $this->t('Forms'),
      'conversion' => (string) $this->t('Conversion'),
      'events' => (string) $this->t('Events'),
      'media' => (string) $this->t('Media'),
      'trust' => (string) $this->t('Trust'),
      'maps' => (string) $this->t('Maps'),
      'social_proof' => (string) $this->t('Social Proof'),
      'stats' => (string) $this->t('Statistics'),
      'team' => (string) $this->t('Team'),
      'timeline' => (string) $this->t('Timeline'),
          // Categorías verticales.
      'agroconecta' => (string) $this->t('AgroConecta'),
      'comercioconecta' => (string) $this->t('ComercioConecta'),
      'serviciosconecta' => (string) $this->t('ServiciosConecta'),
      'empleabilidad' => (string) $this->t('Empleabilidad'),
      'emprendimiento' => (string) $this->t('Emprendimiento'),
    ];
   ...
   */
  public function listTemplatesAjax(): Response {
  ...
  public function previewTemplate(PageTemplateInterface $page_template): array {
    ...
    $preview_iframe_url = Url::fromRoute(
   ...
   */
  public function renderIframe(PageTemplateInterface $page_template): Response {
...
HTML;
  ...
  protected function generateSampleArray(array $property, string $field_name): array {
    ...
    // Generar 3 elementos por defecto.
    $count = 3;
