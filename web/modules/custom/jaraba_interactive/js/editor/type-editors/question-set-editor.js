 ...
 *
 * Sintaxis: Clase QuestionSetEditor con Drupal.behaviors y Drupal.t()
...
(function (Drupal, once) {
  ...
  /**
   * Behavior para registrar la clase QuestionSetEditor.
   *
   ...
   */
  Drupal.behaviors.jarabaQuestionSetEditor = {
    attach: function (context) {
      // AUDIT-CONS-N12: Register class once, available for all AJAX contexts.
      once('jaraba-question-set-editor', 'body', context).forEach(function () {
