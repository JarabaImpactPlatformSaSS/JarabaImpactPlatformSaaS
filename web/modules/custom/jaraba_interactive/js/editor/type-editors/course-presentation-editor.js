 ...
 *
 * Sintaxis: Clase CoursePresentationEditor con Drupal.behaviors,
...
(function (Drupal, once) {
  ...
  /**
   * Behavior para registrar la clase CoursePresentationEditor.
   *
   ...
   */
  Drupal.behaviors.jarabaCoursePresentationEditor = {
    attach: function (context) {
      // AUDIT-CONS-N12: Register class once, available for all AJAX contexts.
      once('jaraba-course-presentation-editor', 'body', context).forEach(function () {
