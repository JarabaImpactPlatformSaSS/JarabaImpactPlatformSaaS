 ...
 *
 * Sintaxis: Clase BranchingScenarioEditor con Drupal.behaviors,
...
(function (Drupal, once) {
  ...
  /**
   * Behavior para registrar la clase BranchingScenarioEditor.
   *
   ...
   */
  Drupal.behaviors.jarabaBranchingScenarioEditor = {
    attach: function (context) {
      // AUDIT-CONS-N12: Register class once, available for all AJAX contexts.
      once('jaraba-branching-scenario-editor', 'body', context).forEach(function () {
