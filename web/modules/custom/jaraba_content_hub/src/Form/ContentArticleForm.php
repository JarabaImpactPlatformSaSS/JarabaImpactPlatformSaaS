  ...
  protected function getSectionDefinitions(): array {
    return [
      'content' => [
        ...
        'fields' => ['title', 'slug', 'excerpt', 'layout_mode', 'body', 'answer_capsule', 'featured_image', 'featured_image_alt'],
      ],
      'taxonomy' => [
        'label' => $this->t('Taxonomy'),
        'icon' => ['category' => 'ui', 'name' => 'tag'],
        'description' => $this->t('Categories, tags, and vertical.'),
        'fields' => ['category', 'tags', 'vertical'],
      ],
      'publishing' => [
        'label' => $this->t('Publishing'),
        'icon' => ['category' => 'actions', 'name' => 'calendar'],
        'description' => $this->t('Status, dates, author, and featured flag.'),
        'fields' => ['status', 'publish_date', 'scheduled_at', 'author', 'content_author', 'is_featured'],
      ],
      'seo' => [
        'label' => $this->t('SEO'),
        'icon' => ['category' => 'analytics', 'name' => 'search'],
        'description' => $this->t('Search engine optimization and structured data.'),
        'fields' => ['seo_title', 'seo_description', 'schema_type', 'og_image'],
      ],
      'metadata' => [
        'label' => $this->t('Metadata'),
        'icon' => ['category' => 'business', 'name' => 'clipboard'],
        'description' => $this->t('AI generation, reading time, engagement, and views.'),
        'fields' => ['ai_generated', 'reading_time', 'engagement_score', 'views_count', 'tenant_id'],
      ],
    ];
  }
