...
/**
 * Control de acceso para la entidad DashboardWidget.
 *
 * PROPOSITO:
 * Gestiona permisos para crear, ver, editar y eliminar widgets de dashboard.
 *
 * LOGICA:
 * - view: requiere 'access jaraba analytics' o 'manage analytics dashboards'
 * - update/delete: requiere 'manage analytics dashboards'
 * - create: requiere 'manage analytics dashboards' o 'create dashboards'
 */
