 ...
 *     "list_builder" = "Drupal\jaraba_copilot_v2\ListBuilder\EntrepreneurLearningListBuilder",
 *     "access" = "Drupal\jaraba_copilot_v2\Access\EntrepreneurLearningAccessControlHandler",
 *     "form" = {
