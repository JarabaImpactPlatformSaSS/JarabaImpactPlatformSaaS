...
class TraceabilityApiController extends ControllerBase implements ContainerInjectionInterface {
  ...
  public static function create(ContainerInterface $container): static {
    ...
    // AUDIT-CONS-N05: canonical prefix.
          $container->get('jaraba_agroconecta_core.traceability_service'),
    // AUDIT-CONS-N05: canonical prefix.
          $container->get('jaraba_agroconecta_core.qr_service'),
  ...
  public function getBatchTraceability(string $code): JsonResponse {
    ...
    if (!$batch) {
      ...
      return new JsonResponse(['success' => FALSE, 'error' => ['code' => 'ERROR', 'message' => 'Lote no encontrado.']], 404);
    }
