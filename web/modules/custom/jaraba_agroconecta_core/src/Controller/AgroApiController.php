...
class AgroApiController extends ControllerBase {
  ...
  public static function create(ContainerInterface $container): static {
    ...
    $instance->productService = $container->get('jaraba_agroconecta_core.product_service');
    // AUDIT-CONS-N05: canonical prefix.
    $instance->producerService = $container->get('jaraba_agroconecta_core.producer_service');
    return $instance;
  }
