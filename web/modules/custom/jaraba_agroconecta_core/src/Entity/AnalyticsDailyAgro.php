...
class AnalyticsDailyAgro extends ContentEntityBase implements EntityChangedInterface, EntityOwnerInterface {
  ...
  public function getGmv(): float {
    return (float) ($this->get('gmv')->value ?? 0);
  }
  ...
  public function getOrdersCount(): int {
    return (int) ($this->get('orders_count')->value ?? 0);
  }
  ...
  public function getAov(): float {
    return (float) ($this->get('aov')->value ?? 0);
  }
  ...
  public function getConversionRate(): float {
    return (float) ($this->get('conversion_rate')->value ?? 0);
  }
