...
/**
 * Step 3: First agro product — AgroConecta Setup Wizard.
 *
 * Checks if the producer has at least one active product in their catalog.
 */
class ProducerCatalogoStep implements SetupWizardStepInterface {
  ...
  public function getDescription(): TranslatableMarkup {
    return $this->t('Añade productos a tu catálogo agrario');
  }
  ...
  /**
   * Gets the count of active agro products for the tenant.
   */
