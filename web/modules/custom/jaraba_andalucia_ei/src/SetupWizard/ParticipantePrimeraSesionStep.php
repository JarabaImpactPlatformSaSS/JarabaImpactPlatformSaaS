...
/**
 * Step 6: Primera sesión formativa — Participante Setup Wizard.
 *
 * Checks if horas_formacion > 0 (at least one session attended).
 * User-scoped via uid.
 */
class ParticipantePrimeraSesionStep implements SetupWizardStepInterface {
  ...
  public function getId(): string {
    return 'participante_ei.primera_sesion';
  }
  ...
  public function getLabel(): TranslatableMarkup {
    return $this->t('Asistir a primera sesión');
  }
  ...
  public function getDescription(): TranslatableMarkup {
    return $this->t('Asiste a tu primera sesión de formación del programa');
  }
  ...
  public function getCompletionData(int $tenantId): array {
    ...
    if ($horas <= 0) {
      return [
        'count' => 0,
        'label' => $this->t('Sin horas de formación registradas'),
      ];
    }

    return [
      'count' => (int) $horas,
      'label' => $this->t('@horas horas de formación', ['@horas' => number_format($horas, 1)]),
    ];
  }
