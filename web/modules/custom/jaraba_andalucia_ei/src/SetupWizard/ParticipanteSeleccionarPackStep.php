...
/**
 * Step 5: Seleccionar pack — Participante Setup Wizard.
 *
 * Checks if pack_preseleccionado is not null. Optional step.
 * User-scoped via uid.
 */
class ParticipanteSeleccionarPackStep implements SetupWizardStepInterface {
  ...
  public function getId(): string {
    return 'participante_ei.seleccionar_pack';
  }
  ...
  public function getLabel(): TranslatableMarkup {
    return $this->t('Seleccionar pack de servicios');
  }
  ...
  public function getDescription(): TranslatableMarkup {
    return $this->t('Elige el pack de servicios que más se adapte a tu negocio');
  }
  ...
  public function isComplete(int $tenantId): bool {
    ...
    return $participante->get('pack_preseleccionado')->value !== NULL;
  }
  ...
  public function getCompletionData(int $tenantId): array {
    ...
    $pack = $participante->get('pack_preseleccionado')->value;
    if ($pack === NULL) {
      return [
        'count' => 0,
        'label' => $this->t('Sin pack preseleccionado'),
      ];
    }

    return [
      'count' => 1,
      'label' => $this->t('Pack preseleccionado: @pack', ['@pack' => $pack]),
    ];
  }
