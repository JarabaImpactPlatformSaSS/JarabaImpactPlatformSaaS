...
/**
 * Access control handler for ClienteParticipanteEi.
 *
 * View: admin OR owner OR 'access andalucia ei participante portal'.
 * Create: admin OR 'access andalucia ei participante portal'.
 * Update: admin OR owner (with tenant check).
 * Delete: admin only.
 *
 ...
 */
class ClienteParticipanteEiAccessControlHandler extends EntityAccessControlHandler implements EntityHandlerInterface {

  /**
   * Constructs a new ClienteParticipanteEiAccessControlHandler.
   *
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account): AccessResultInterface {
    ...
    return match ($operation) {
      'view' => AccessResult::allowedIfHasPermission($account, 'access andalucia ei participante portal')
        ->orIf(AccessResult::allowedIf($isOwner))
