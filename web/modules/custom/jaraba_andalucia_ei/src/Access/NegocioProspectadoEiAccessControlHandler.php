...
/**
 * Access control handler for NegocioProspectadoEi.
 *
 * View: admin OR 'register andalucia ei actuacion'.
 * Create: admin OR 'register andalucia ei actuacion'.
 ...
 */
class NegocioProspectadoEiAccessControlHandler extends EntityAccessControlHandler implements EntityHandlerInterface {

  /**
   * Constructs a new NegocioProspectadoEiAccessControlHandler.
   *
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account): AccessResultInterface {
    ...
    return match ($operation) {
      'view' => AccessResult::allowedIfHasPermission($account, 'register andalucia ei actuacion')
  ...
  protected function checkCreateAccess(AccountInterface $account, array $context, $entity_bundle = NULL): AccessResultInterface {
    return AccessResult::allowedIfHasPermission($account, 'register andalucia ei actuacion')
