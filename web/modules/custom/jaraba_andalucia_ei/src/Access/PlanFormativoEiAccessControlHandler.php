...
/**
 * Access control handler for PlanFormativoEi entities.
 *
 ...
 */
class PlanFormativoEiAccessControlHandler extends EntityAccessControlHandler implements EntityHandlerInterface {
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account): AccessResultInterface {
    ...
    return match ($operation) {
      'view' => AccessResult::allowedIfHasPermission($account, 'view plan formativo ei')
        ->addCacheableDependency($entity),
      'update' => AccessResult::allowedIfHasPermission($account, 'edit plan formativo ei')
        ->addCacheableDependency($entity),
      'delete' => AccessResult::allowedIfHasPermission($account, 'delete plan formativo ei')
        ->addCacheableDependency($entity),
