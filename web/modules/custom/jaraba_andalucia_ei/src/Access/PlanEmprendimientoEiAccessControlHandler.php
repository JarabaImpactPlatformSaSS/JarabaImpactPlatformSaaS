...
/**
 * Access control handler for PlanEmprendimientoEi.
 *
 ...
 */
class PlanEmprendimientoEiAccessControlHandler extends EntityAccessControlHandler implements EntityHandlerInterface {
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account): AccessResultInterface {
    ...
    return match ($operation) {
      'view' => AccessResult::allowedIfHasPermission($account, 'access content')
        ->addCacheableDependency($entity),
      'update' => AccessResult::allowedIfHasPermission($account, 'administer andalucia ei')
        ->addCacheableDependency($entity),
      'delete' => AccessResult::allowedIfHasPermission($account, 'administer andalucia ei')
        ->addCacheableDependency($entity),
