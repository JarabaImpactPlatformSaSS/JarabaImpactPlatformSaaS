...
/**
 * Access control handler for AccionFormativaEi entities.
 *
 ...
 */
class AccionFormativaEiAccessControlHandler extends EntityAccessControlHandler implements EntityHandlerInterface {
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account): AccessResultInterface {
    ...
    return match ($operation) {
      'view' => AccessResult::allowedIfHasPermission($account, 'view accion formativa ei')
        ->addCacheableDependency($entity),
      'update' => AccessResult::allowedIfHasPermission($account, 'edit accion formativa ei')
        ->addCacheableDependency($entity),
      'delete' => AccessResult::allowedIfHasPermission($account, 'delete accion formativa ei')
        ->addCacheableDependency($entity),
