...
/**
 * Access control handler for ProspeccionEmpresarial.
 *
 ...
 */
class ProspeccionEmpresarialAccessControlHandler extends EntityAccessControlHandler {
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account): AccessResultInterface {
    ...
    if ($operation === 'view') {
      return AccessResult::allowedIfHasPermission($account, 'view prospeccion empresarial');
    }
    ...
    if (in_array($operation, ['update', 'delete'], TRUE)) {
      ...
      return AccessResult::allowedIf($isOwner)
        ->andIf(AccessResult::allowedIfHasPermission($account, 'edit prospeccion empresarial'))
        ->addCacheableDependency($entity);
    }
