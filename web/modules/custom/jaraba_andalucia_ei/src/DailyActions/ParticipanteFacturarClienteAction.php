...
/**
 * Daily action: invoice clients for participante.
 *
 * Visible from fase 'insercion' onwards.
 * User-scoped via uid.
 */
class ParticipanteFacturarClienteAction implements DailyActionInterface {
  ...
  public function getId(): string {
    return 'participante_ei.facturar_cliente';
  }
  ...
  public function getLabel(): TranslatableMarkup {
    return $this->t('Facturar a cliente');
  }
  ...
  public function getDescription(): TranslatableMarkup {
    return $this->t('Genera facturas para los servicios prestados a clientes');
  }
  ...
  public function getIcon(): array {
    return ['category' => 'business', 'name' => 'invoice', 'variant' => 'duotone'];
  }
