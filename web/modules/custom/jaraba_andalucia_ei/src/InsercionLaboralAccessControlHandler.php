...
/**
 * Access control handler for InsercionLaboral.
 *
 ...
 */
class InsercionLaboralAccessControlHandler extends EntityAccessControlHandler {
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account): AccessResultInterface {
    ...
    if ($operation === 'view') {
      return AccessResult::allowedIfHasPermission($account, 'view insercion laboral');
    }
    ...
    if (in_array($operation, ['update', 'delete'], TRUE)) {
      ...
      return AccessResult::allowedIf($isOwner)
        ->andIf(AccessResult::allowedIfHasPermission($account, 'edit insercion laboral'))
        ->addCacheableDependency($entity);
    }
