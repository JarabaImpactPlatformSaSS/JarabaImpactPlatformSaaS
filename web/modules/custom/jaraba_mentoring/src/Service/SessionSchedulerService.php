...
class SessionSchedulerService {
   ...
   * Books a session.
   *
   * @param \Drupal\jaraba_mentoring\Entity\MentoringEngagement $engagement
   *   The engagement.
   ...
   *   Duration in minutes.
   *
   * @return \Drupal\jaraba_mentoring\Entity\MentoringSession|null
  ...
  public function bookSession(MentoringEngagement $engagement, string $start_datetime, int $duration_minutes = 60): ?MentoringSession {
    ...
    /** @var \Drupal\jaraba_mentoring\Entity\MentoringSession $session */
  ...
  public function cancelSession(MentoringSession $session, string $reason, bool $refund_session = TRUE): bool {
    ...
    if ($refund_session) {
      ...
      /** @var \Drupal\jaraba_mentoring\Entity\MentoringEngagement $engagement */
