...
namespace Drupal\jaraba_lms\Grounding;
...
/**
 * Grounding provider para cursos LMS (lms_course).
 */
class CourseGroundingProvider implements GroundingProviderInterface {
