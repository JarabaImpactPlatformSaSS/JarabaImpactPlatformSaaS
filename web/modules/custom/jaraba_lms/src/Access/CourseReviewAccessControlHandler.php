...
namespace Drupal\jaraba_lms\Access;
...
/**
 * Control de acceso para course_review con verificacion de tenant.
 *
 * TENANT-ISOLATION-ACCESS-001: update/delete requieren mismo tenant.
 */
class CourseReviewAccessControlHandler extends EntityAccessControlHandler implements EntityHandlerInterface {
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account): AccessResult {
    if ($account->hasPermission('administer lms')) {
