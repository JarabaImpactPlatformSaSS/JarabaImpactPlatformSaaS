...
class AupViolationAccessControlHandler extends EntityAccessControlHandler {
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account): AccessResult {
    ...
    switch ($operation) {
      ...
      case 'update':
      case 'delete':
        // AUP violations son auto-generadas, solo admin puede modificar/eliminar.
