...
/**
 * Control de acceso para la entidad Pilot Program.
 *
 ...
 */
class PilotProgramAccessControlHandler extends EntityAccessControlHandler implements EntityHandlerInterface {
