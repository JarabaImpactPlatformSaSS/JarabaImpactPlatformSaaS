...
/**
 * Control de acceso para entidades AgentFlowStepLog.
 *
 * PROPOSITO:
 * Gestiona permisos de lectura de logs de pasos de ejecucion.
 *
 * LOGICA:
 * - view: requiere 'view agent flow executions'
 * - delete: requiere 'administer agent flows'
 */
class AgentFlowStepLogAccessControlHandler extends EntityAccessControlHandler {
