...
class CredentialIssuer {
  ...
  public function signExistingCredential(IssuedCredential $credential): bool {
    ...
    $params = [
      ...
      'recipient' => [
        'email' => $credential->get('recipient_email')->value ?? ($user instanceof UserInterface ? $user->getEmail() : ''),
        'name' => $credential->get('recipient_name')->value ?? ($user instanceof UserInterface ? $user->getDisplayName() : ''),
      ],
      'issued_on' => $issuedOn,
      'expires_on' => $expiresOn,
