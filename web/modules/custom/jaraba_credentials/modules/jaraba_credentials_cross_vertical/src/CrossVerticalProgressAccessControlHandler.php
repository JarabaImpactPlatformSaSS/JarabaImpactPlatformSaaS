...
/**
 * Access control handler para CrossVerticalProgress.
 */
class CrossVerticalProgressAccessControlHandler extends DefaultEntityAccessControlHandler {
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account): AccessResultInterface {
    ...
    if ($operation === 'view') {
      ...
      if ($account->hasPermission('view cross vertical progress')) {
        return AccessResult::allowed()
          ->cachePerPermissions()
          ->addCacheableDependency($entity);
      }
