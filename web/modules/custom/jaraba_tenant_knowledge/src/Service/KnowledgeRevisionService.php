...
/**
 * Servicio de comparación de revisiones de conocimiento del tenant.
 *
 * PROPÓSITO:
 * Proporciona funcionalidad de diff visual para comparar revisiones
 * de TenantFaq y TenantPolicy, identificando cambios campo a campo.
 *
 * LÓGICA:
