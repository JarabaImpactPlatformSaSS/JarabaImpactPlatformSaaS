...
/**
 * Premium form for Tenant FAQ entities.
 */
class TenantFaqForm extends PremiumEntityFormBase {
  ...
  protected function getSectionDefinitions(): array {
    return [
      'content' => [
        ...
        'description' => $this->t('Question, answer, and variants.'),
        'fields' => ['question', 'answer', 'question_variants'],
      ],
      'settings' => [
        'label' => $this->t('Settings'),
        'icon' => ['category' => 'ui', 'name' => 'settings'],
        'description' => $this->t('Category, priority, and publishing.'),
        'fields' => ['category', 'priority', 'is_published'],
      ],
    ];
  }
