...
/**
 * Premium form for KB Article entities.
 */
class KbArticleForm extends PremiumEntityFormBase {
  ...
  protected function getSectionDefinitions(): array {
    return [
      'content' => [
        ...
        'description' => $this->t('Main article content.'),
        'fields' => ['title', 'slug', 'body', 'summary'],
      ],
      'settings' => [
        'label' => $this->t('Settings'),
        'icon' => ['category' => 'ui', 'name' => 'settings'],
        'description' => $this->t('Category, author, and status configuration.'),
        'fields' => ['category_id', 'author_id', 'article_status', 'tags'],
      ],
    ];
  }
