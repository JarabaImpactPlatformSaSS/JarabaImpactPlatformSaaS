...
/**
 * Control de acceso para la entidad KbArticle.
 *
 * PROPÓSITO:
 * Gestiona permisos para artículos de la base de conocimiento.
 *
 * LÓGICA:
 * - Admin global puede todo
 * - view: requiere 'view knowledge base'
 * - update/delete: requiere 'manage kb articles'
 * - create: requiere 'manage kb articles'
 */
class KbArticleAccessControlHandler extends EntityAccessControlHandler {
