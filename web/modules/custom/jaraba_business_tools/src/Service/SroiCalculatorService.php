...
class SroiCalculatorService {
  ...
  // Annual economic value per job.
    'job_created' => 25000,
  // Economic value of preserved job.
    'job_preserved' => 18000,
  // Value of formal business registration.
    'business_formalized' => 5000,
  // Per skill gained.
    'digital_skill_acquired' => 800,
  // 15% social value multiplier.
    'revenue_generated' => 0.15,
  // EUR per kg CO2 saved.
  ...
  // SDG 8: Decent Work, SDG 1: No Poverty.
    'jobs' => [8, 1],
  // SDG 8: Decent Work, SDG 9: Industry.
    'business' => [8, 9],
  // SDG 4: Education, SDG 9: Industry.
    'digital' => [4, 9],
  ...
  protected function gatherOutcomes(array $options): array {
    ...
    // ~3 skills per path
    $outcomes['digital_skills_acquired'] = $completedPaths * 3;
    ...
    $outcomes['mentoring_hours'] = $sessions * 1.5;
