 ...
 * @endcode
 */
$settings['hash_salt'] = '5ECFsRVU-ouHN78sT6LZ8vfFTDvdnYqgL4CALCVVESwX6BxPZUUlmQCVUPLrrU8WQ5RjJy_ZlQ';
...
if (file_exists($_jaraba_rag_config)) {
  include $_jaraba_rag_config;
}

/**
 * Trusted host patterns.
 *
 * Configuración según documentación oficial de Drupal:
 * https://www.drupal.org/docs/installing-drupal/trusted-host-settings
 */
$settings['trusted_host_patterns'] = [
  // Lando development URLs
