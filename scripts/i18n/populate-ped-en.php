...
$dict = [
  ...
  'Infraestructura Digital para el Desarrollo Local y la Transformacion de Territorios' => 'Digital Infrastructure for Local Development and Territorial Transformation',
  ...
  'Co-fundada por Jos\u00e9 Jaraba Mu\u00f1oz (Pepe Jaraba), PED integra mas de tres decadas de experiencia en desarrollo local, formacion profesional, transformacion digital y gestion de fondos europeos en una plataforma SaaS multi-vertical.' => 'Co-founded by Jos\u00e9 Jaraba Mu\u00f1oz (Pepe Jaraba), PED integrates over three decades of experience in local development, professional training, digital transformation and European fund management into a multi-vertical SaaS platform.',
  ...
  'Ser la infraestructura digital de referencia para el desarrollo local sostenible en el mundo hispanohablante, conectando instituciones, empresas y personas en un ecosistema de impacto medible.' => 'To be the leading digital infrastructure for sustainable local development in the Spanish-speaking world, connecting institutions, businesses and people in a measurable impact ecosystem.',
  ...
  // =========================================================================
  'Con mas de 30 anos de experiencia en desarrollo local, formacion profesional y transformacion digital, Pepe Jaraba ha liderado proyectos de impacto en mas de 120 municipios de Andalucia. Su trayectoria incluye la gestion de mas de 100 millones de euros en fondos europeos y la creacion de programas formativos que han beneficiado a mas de 50.000 personas.' => 'With over 30 years of experience in local development, professional training and digital transformation, Pepe Jaraba has led impact projects in over 120 municipalities across Andalusia. His track record includes managing over 100 million euros in European funds and creating training programs that have benefited over 50,000 people.',
