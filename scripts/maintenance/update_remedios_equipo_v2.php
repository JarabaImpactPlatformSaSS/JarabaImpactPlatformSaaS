    ...
    <div class="ped-section__narrow">
      <div class="ped-founder__hero">
        ...
        <div>
          ...
          <p class="ped-founder__bio">Licenciada en Economía por la UNED (2002, especialidad Análisis Económico), Máster MBA en Dirección de Instituciones Sociales y Atención a la Dependencia (IEEE, 600 horas) y Máster Europeo MBA en Servicios Sociales (IEEE, 700 horas). Certificado Profesional de Habilitación para la Docencia en Formación Profesional (SSCE0110, 2024) y Docencia de la Formación para el Empleo por la Universidad Nebrija (350 horas, 14 créditos ECTS, 2023).</p>
          <p class="ped-founder__bio">Desde 2005 dirige la Sociedad Municipal de Desarrollo de Monturque S.L. (Córdoba), una empresa pública municipal dedicada al desarrollo económico local, la formación para el empleo y el acompañamiento al emprendimiento. Bajo su dirección, ha gestionado decenas de programas de empleo y formación financiados por la Junta de Andalucía, el FSE y la Diputación Provincial.</p>
