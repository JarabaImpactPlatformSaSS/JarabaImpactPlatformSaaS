    ...
    <div class="ped-section__narrow">
      <div class="ped-founder__hero">
        ...
        <div>
          ...
          <p class="ped-founder__bio">Licenciada en Economía por la UNED (2002, especialidad Análisis Económico), con dos Másters MBA (Dirección de Instituciones Sociales por IEEE, 600 horas, y Máster Europeo en Servicios Sociales por IEEE, 700 horas), Certificado Profesional de Habilitación para la Docencia en FP (SSCE0110, 2024) y Docencia de la Formación para el Empleo por la Universidad Nebrija (350 horas, 14 créditos ECTS). Remedios Estévez combina una formación económica rigurosa con más de 20 años de experiencia directa en gestión pública local, empleo y emprendimiento. Bajo su dirección, ha gestionado decenas de programas financiados por la Junta de Andalucía, el FSE y la Diputación Provincial, con impacto directo en cientos de personas en situación de desempleo y emprendedores. Su formación complementaria suma más de 5.000 horas en +70 cursos.</p>
          <p class="ped-founder__bio">Desde 2005 dirige la Sociedad Municipal de Desarrollo de Monturque S.L. (Córdoba), una empresa pública dedicada a la prestación de servicios públicos locales.</p>
          <p class="ped-founder__bio">Su formación complementaria incluye dos especializaciones en Régimen Jurídico de las Administraciones Públicas (Universidad Miguel de Cervantes, 250 horas cada una), Técnico Superior en Inteligencia Emocional Empresarial (IEEE, 220 horas), Formadora Ocupacional (Fundación Tripartita/FSE, 380 horas) y más de 70 cursos adicionales que suman más de 5.000 horas de formación continua en materias de gestión pública, empleo, igualdad, prevención de riesgos y administración electrónica.</p>
