...
**Fecha:** 2026-03-06
**Versión:** 108.0.0 (SEO/GEO Meta-Sitio Corporativo 10/10 — og:image fallback chain, hreflang dedup, NAP normalization, orphan template fix, cookie localStorage-first + aprendizaje #170)
