...
**Versión:** 135.0.0 (DEPLOY-ENV-ORDER-001 + CSRF-LOGIN-FIX-001 v2 — fix pipeline deploy settings.env.php post git-reset, reCAPTCHA root cause analysis, HTTPS detection 3 capas + regla de oro #126 + aprendizaje #185)
