...
**Versión:** 164.0.0 (MEGAMENU-INJECT-001 — canal secundario theme_settings._mega_menu_columns resuelve mega menú vacío en 35 templates, isDefault() guard en MetaSiteResolverService, caso de éxito PED S.L. reescrito con datos reales PIIL, "Desarrollo Local" en mega menú instituciones, 106 scripts (89 run + 17 warn) + aprendizaje #216)
