...
**Versión:** 115.0.0 (Stripe Embedded Checkout: STRIPE-CHECKOUT-001, checkout self-service con Stripe ui_mode embedded, sync bidireccional Product/Price, zero-region templates + aprendizaje #165)
