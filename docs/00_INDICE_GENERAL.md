...
**Versión:** 150.0.0 (Twig Render Array Safety + Entity Update Hook Hardening — 4 reglas: TWIG-URL-RENDER-ARRAY-001, TWIG-INCLUDE-ONLY-001, UPDATE-HOOK-FIELDABLE-001, TRANSLATABLE-FIELDS-INSTALL-001 + aprendizaje #171)
...
| 2026-03-09 | **150.0.0** | **Twig Render Array Safety + Entity Update Hook Hardening:** Descubrimiento critico: `url()` en Drupal 11 Twig devuelve render array (TwigExtension::getUrl() lineas 244-247), no string — concatenar con `~` genera "Array to string conversion". Fix _seo-schema.html.twig (url() solo dentro de `{{ }}`, logo type-safe con `is iterable`, includes con `only` + directory explicito). Fix orphan metatag field storage en billing_usage_record (jaraba_billing_update_10005) y site_config (jaraba_site_builder_update_10009) — causa raiz: update hooks previos usaron getBaseFieldDefinitions() con updateFieldableEntityType() incluyendo campo computed metatag que no tiene storage. Fix 6 campos content_translation en site_config (translatable=TRUE sin instalar campos tracking). 4 reglas: TWIG-URL-RENDER-ARRAY-001 (P0), TWIG-INCLUDE-ONLY-001 (P1), UPDATE-HOOK-FIELDABLE-001 (P0), TRANSLATABLE-FIELDS-INSTALL-001 (P0). Regla de oro #111. Aprendizaje #171. |
| 2026-03-06 | **149.0.0** | **SEO/GEO Meta-Sitio Corporativo 10/10 + Landing Reclutamiento Elevation:** Page Builder SEO: meta description injection + og:image fallback cascade 5 niveles (og-image-dynamic.png). Hreflang dedup: `is_page_content` condicional en html.html.twig, URLs absolutas. Orphan templates: `_ped-schema.html.twig` (Corporation + GeoCoordinates 2 sedes) + `_seo-schema.html.twig` ahora incluidos en html.html.twig. NAP: telefono/email/WhatsApp normalizados, placeholders eliminados. Cookie banner: localStorage-first (submit antes de fetch). Landing reclutamiento: ZERO-REGION-003, publicidad oficial PIIL CV, EducationalOccupationalProgram schema, geo meta (ES-AN, ICBM), popup meta-sites. Nuevo aprendizaje: `docs/tecnicos/aprendizajes/2026-03-06_seo_geo_meta_sitio_corporativo_10_10.md` (#170). 5 reglas: SEO-OG-IMAGE-FALLBACK-001, HREFLANG-CONDITIONAL-001, NAP-NORMALIZATION-001, ORPHAN-TEMPLATE-001, COOKIE-CONSENT-LOCAL-FIRST. Reglas de oro #106-108. |
