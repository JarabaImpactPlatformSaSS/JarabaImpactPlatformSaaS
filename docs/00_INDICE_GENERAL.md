...
### Documentos completados:
- [x] Definición de Planes SaaS
- [x] Pagos y Monetización (Doc. Maestro §7)
...
- [x] **ecosistema_jaraba_core** - 85+ archivos | [README](../web/modules/custom/ecosistema_jaraba_core/README.md)
  ...
  - **Estado:** ✅ Evolution Sprint completado (2026-01-10)
...
> 📥 Esta carpeta contiene documentos técnicos proporcionados externamente y especificaciones de terceros.

### 7.1 Trazabilidad y Blockchain

| Documento | Descripción | Fuente |
|-----------|-------------|--------|
| [20260108a-AgroConecta_ Trazabilidad y Blockchain_Gemini.md](./tecnicos/20260108a-AgroConecta_%20Trazabilidad%20y%20Blockchain_Gemini.md) | 🔗 Análisis integral trazabilidad + blockchain, módulo `agroconecta_integrity` | Gemini |
| [20260108b-Evaluación de Plataformas Blockchain para AgroConecta_Gemini.md](./tecnicos/20260108b-Evaluación%20de%20Plataformas%20Blockchain%20para%20AgroConecta_Gemini.md) | ⚖️ Comparativa EBSI vs OpenTimestamps vs IBM Food Trust | Gemini |

### 7.2 Certificados Digitales y Firma Electrónica

| Documento | Descripción | Fuente |
|-----------|-------------|--------|
| [20260109a-AgroConecta_Certificados_Digitales_FNMT_Claude.md](./tecnicos/20260109a-AgroConecta_Certificados_Digitales_FNMT_Cluade.md) | 🔐 Integración con certificados X.509 de la FNMT | Claude |
| [20260109b-AgroConecta_Firma_Automatica_Lotes_Claude.md](./tecnicos/20260109b-AgroConecta_Firma_Automatica_Lotes_Claude.md) | ✍️ Sistema de firma automática en servidor (TCPDF, TSA FNMT) | Claude |
| [20260109c-AgroConecta_AutoFirma_Integracion_Claude.md](./tecnicos/20260109c-AgroConecta_AutoFirma_Integracion_Claude.md) | 🖥️ Integración con AutoFirma del Gobierno de España | Claude |
...
> ⚠️ El código de estas carpetas ha sido **migrado** a `web/modules/custom/ecosistema_jaraba_core/`

| Recurso | Descripción |
|---------|-------------|
| [Código AutoFirma Claude/](./tecnicos/Código%20AutoFirma%20Claude/) | AutoFirmaController.php, agroconecta-firma.js, _autofirma.scss |
| [Código Certificación Lotes Claude/](./tecnicos/Código%20Certficación%20Lotes%20Claude/) | FirmaDigitalService.php, CertificadoPdfService.php |

**Total documentos técnicos:** 6  
**Total recursos de código:** 2 carpetas → migradas a módulo
...
| **Documentos de implementación** | 9 |
| **Documentos técnicos** | 6+ carpetas |
...
> - Integración Ecwid (e-commerce)
> - Agentes IA (orquestador, agentes especializados)
> 
> Consultar ese workspace para documentación detallada de implementación.
...
|-------|---------|-------------|
| 2026-01-09 | 1.0.0 | Creación inicial del índice general |
| 2026-01-09 | 1.1.0 | Añadidos plan de estructura e informe de implementación |
| 2026-01-09 | 1.2.0 | Integración de 7 documentos técnicos |
| 2026-01-09 | 1.3.0 | Añadido análisis de madurez arquitectónica SaaS |
| 2026-01-09 | 1.4.0 | Añadido documento de Arquitectura de Alto Nivel con diagramas C4 completos |
| 2026-01-09 | 2.0.0 | Documentación completa de Nivel 5 Arquitectura Adaptativa |
| 2026-01-09 | 2.1.0 | Añadido informe de validación del entorno SaaS, actualizado estado del módulo core |
